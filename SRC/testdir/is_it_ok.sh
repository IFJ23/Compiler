...
# pouziti:   is_it_ok.sh xpokhv00.zip testdir
#  
#   - POZOR: obsah adresare zadaneho druhym parametrem bude VYMAZAN (po dotazu)!
#   - rozbali archiv studenta xpokhv00.zip do adresare testdir a overi formalni pozadavky pro odevzdani projektu IFJ
